...
float3 CalcCaustics(float3 positionWS){
    ...
    half2 uv1 = _Time * panDir * 0.12 + uv * 0.47 * Ocean_WaveScale;
    half2 uv2 = _Time * panDir * float2(-0.1, -0.13) + uv * 0.43 * Ocean_WaveScale;
    ...
    return min(caustics1, caustics2) * light * (saturate(heightPercent - topFade));
}
